...
Client.prototype.request = function(opts, callback) {
    ...
    if (client.adal_auth)
        opts.headers[Headers.AUTHORIZATION] = 'Bearer ' + client.adal_auth.access_token;
            ...
            */
            ...
            client.request(next_uri, function(error, code, response){
                ...
                if (!response || !response.stats) {
                    ...
                    error_callback({message: "unexpected: successful presto response was undefined or did not contain stats info. response: " + JSON.stringify(response), code: code})
                }
